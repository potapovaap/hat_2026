...
extension startNewPlayerVC {
    ...
    func setConstraints() {
        ...
        for itemView in [backgroundImageView, whiteCenterImageView, infoLabel, firstPlayerLabel, secondPlayerLabel, startButton, taskLabel] {
		...
		firstPlayerLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 0).isActive = true
		secondPlayerLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 0).isActive = true
        ...
        if gameWithTasks {
            ...
            secondPlayerLabel.bottomAnchor.constraint(equalTo: taskLabel.topAnchor, constant: -15).isActive = true
            infoLabel.bottomAnchor.constraint(equalTo: secondPlayerLabel.topAnchor, constant: -15).isActive = true
            firstPlayerLabel.bottomAnchor.constraint(equalTo: infoLabel.topAnchor, constant: -15).isActive = true
            startButton.topAnchor.constraint(equalTo: taskLabel.bottomAnchor, constant: 20).isActive = true
        } else {
            infoLabel.bottomAnchor.constraint(equalTo: secondPlayerLabel.topAnchor, constant: -15).isActive = true
            firstPlayerLabel.bottomAnchor.constraint(equalTo: infoLabel.topAnchor, constant: -30).isActive = true
            secondPlayerLabel.topAnchor.constraint(equalTo: view.centerYAnchor, constant: 10).isActive = true
            taskLabel.bottomAnchor.constraint(equalTo: infoLabel.topAnchor, constant: -30).isActive = true
            startButton.topAnchor.constraint(equalTo: secondPlayerLabel.bottomAnchor, constant: 30).isActive = true
        }
		...
		firstPlayerLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
		firstPlayerLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10).isActive = true

		secondPlayerLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
		secondPlayerLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10).isActive = true
		...
		infoLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24).isActive = true

		firstPlayerLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24).isActive = true
		firstPlayerLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24).isActive = true

		secondPlayerLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24).isActive = true
		secondPlayerLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24).isActive = true
